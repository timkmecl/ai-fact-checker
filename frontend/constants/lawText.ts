...
Zakon nikomur ne daje licence za ubijanje. V skladu z zakonom ne more nihče nikogar ubiti.

Zakon o PPKŽ ne daje državi pravice, da koga ubije. Prav nasprotno, moč daje posamezniku, da ne postane ujetnik tuje volje, institucije ali ideologije.

Ponujanje PPKŽ je protizakonito in kaznivo.

Morebitni kršitelj postopka PPKŽ bo kaznovan v skladu s kazenskim zakonikom. Globe, ki jih predvideva zakon pa so namenjene pravni osebi, pri kateri je zaposlen.

Obveščanje svojcev o namenu pacienta, da uveljavi pravico do PPKŽ, je v skladu s pacientovo pravico do zasebnosti, kot jo določa Zakon o pacientovih pravicah.

Zavajajoča je trditev, da bo zakon povzročil družbeni pritisk na paciente naj zaprosijo za PPKŽ. Trditev ne temelji na nobeni znanstveni študiji, ampak je povsem propagandnega značaja. Občutek, biti v breme svojcem, ni med glavnimi razlogi za željo po PPKŽ. Glavni razlog je izguba samostojnosti in nezmožnost doživljati vse tisto, kar daje življenju smisel

Ni podatkov, da bi se k PPKŽ pogosteje zatekali ljudje iz socialno ali ekonomsko prikrajšanih okolij. Prav nasprotno: večina prosilcev je nadpovprečno izobraženih in materialno preskrbljenih. To so ljudje, ki znajo jasno izraziti svojo voljo.

Trditev, da se poveča število evtanazij pacientov pred prazniki in dopusti zaradi pritiska svojcev je lažniva. Gre za evtanazije hišnih ljubljenčkov psov in mačk. 

Zakon ni neustaven. 17. člen ustave, ki govori o nedotakljivosti življenja, se nanaša na nedotakljivost s strani države in zato nimamo smrtne kazni, samousmrtitev pa ni kazniva.

Neskladja s kazenskim zakonikom ne bo, ker pomoč pri samomoru ne bo kazniva, če bo izvedena v skladu z zakonom o PPKŽ.

Ne bo nobenega avtomobila, ki bi po nalogu vlade vozil zdravstvene delavce z injekcijami, s katerimi bi ubijali stare, onemogle, osamljene, da bi državni proračun zmanjšal izdatke za zdravstvo in pokojnine. 

Zakon ne omogoča nobenega prekupčevanja s človeškimi organi. O odvzemu in presajanju človeških organov ima Slovenija odličen poseben zakon, ki omogoča nenehen nadzor nad vsakim presaditvenim organom in dogodkom.

Trditev, da v Kanadi 15 % organov za presajanje prihaja od evtanaziranih pacientov je lažniva. Med ljudmi, ki se odločijo za PPKŽ, je 15 % takih, ki izrazijo željo po darovanju svojih organov kot plemenito dejanje pred smrtjo. Med vsemi darovalci organov v Kanadi pa je tistih, ki so umrli v postopku PPKŽ, manj kot 1 %.

Nobenega primera PPKŽ se ne bo dalo prikriti.V celotnem postopku udeleženci izpolnijo najmanj pet obrazcev, ki jih hrani komisija za PPKŽ, zato bo o vsakem primeru obstajala obširna dokumentacija.

Zakon ne predvideva poteka postopka brez podpisov. Svojo voljo bo vsak pacient potrdil s svojim podpisom pred notarjem. Če se ne bo zmogel podpisati, bo voljo narekoval, zapis nareka pa bo potrdil s podpisom notar.
...
Vsi zdravstveni delavci, ki bi lahko sodelovali v postopku, imajo pravico ugovora vesti, kar pomeni, da jih v sodelovanje nihče ne sili. Tudi ne bodo kaznovani, če ne bodo sodelovali. Če že govorimo o prisili, se ta danes izvaja nad bolniki: prisiljeni so živeti dlje, kot bi si želeli, čeprav prosijo, naj se njihovo trpljenje konča. 


Trditev, da zakon spodbuja samomorilnost, proti kateri se borimo, zlonamerno enači dve popolnoma različni dejanji. Samomor je impulzivno dejanje v trenutku obupa, depresije ali osamljenosti. Pri PPKŽ gre za premišljeno odločitev neozdravljivo trpečega človeka. Odločitev se večkrat preverja in vključuje oceno psihiatra o pacientovi sposobnosti odločanja o sebi. 

Iskanje primerjav v Kanadi, na Nizozemskem, v Belgiji je zavajajoče in neprimerno, ker imajo tam uzakonjeno evtanazijo, ki je v našem zakonu ni. Pomoč pri samousmrtitvi se tam zgodi v manj kot 1% primerov.

Trditev, da na Nizozemskem evtanazirajo ljudi brez njihove pisne privolitve je zavajajoča. Tam posege, ki so bili zaradi pacientove neprisebnosti izvedeni brez njegovega pisnega soglasja in so se končali s smrtjo, statistično zabeležijo kot evtanazije brez privolitve. V to skupino sodijo smrti v postopku paliativne sedacije in zdravljenja z dvojnim učinkom. Takih neposrednih vzrokov smrti v Sloveniji statistika ne registrira, čeprav so številne, tako kot tudi ne smrti zaradi odklopov od naprav za vzdrževanje življenja in zdravniških napak. Zato v Sloveniji uradno evtanazije ni.

Trditev, da zakon uvaja kulturo smrti, je zavržna obtožba, ki je namenjena utišanju in moralni diskvalifikaciji zagovornikov zakona. Nihče, ki podpira PPKŽ, ne slavi smrti. Prav nasprotno se zavzemamo za življenje, ki ima za človeka vsebino, smisel in dostojanstvo, ter pravico, da ne ostane ujet v neznosnem trpljenju, ko življenje postane zgolj podaljševanje trpljenja.

Tisti, ki govorijo o »kulturi smrti«, branijo sistem "kulture trpljenja", v katerem je človek prisiljen trpeti tudi ko jasno pove, da tega ne zmore več. To ni obramba življenja, temveč obramba trpljenja – vztrajanje pri načelu ohranjanja telesa za ceno človekove osebnosti.
...
Zakon omogoča življenje napolnjeno s smislom do dostojanstvenega konca.

Zakon omogoča miren konec v družbi in objemu najdražjih.

Zakon omogoča svojcem pripravo in ljubeče slovo ter s tem preprečuje njihovo trpljenje.

Zakon vse razbremeni strahu o tem, kakšen bo konec njihovega življenja. Zavedanje, da je v primeru neznosnega trpljenja na voljo pomoč, prinaša olajšanje in občutek varnosti vsakomur. Zato vsakdo glasuje o svoji usodi.
...
Paliativno oskrbo podpiramo vsi in jo jo je potrebno razvijati naprej. Nikoli pa ne more pomagati prav vsem, ti zato trpijo in potrebujejo pomoč pri končanju življenja. Zakon in paliativna oskrba se dopolnjujeta in ne nadomeščata. 70% bolnikov, ki zaprosijo za PPKŽ, prihaja iz paliativne oskrbe.

Uzakonitev PPKŽ ne ovira razvoja paliativne oskrbe. Dogaja se ravno obratno. V več državah se je pokazalo, da je razprava o PPKŽ spodbudila krepitev paliativne oskrbe. To se dogaja tudi v Sloveniji.

[Z zakonom se Slovenija vzpostavlja kot prva država na svetu, kjer je pomoč pri prostovoljnem končanju življenja uzakonjena kot pravica in ni zgolj dejanje sočutja po izbiri zdravnikov.]
`;

export const ZPPKZ_LAW_TEXT = `# Sprejeti ZPPKŽ
